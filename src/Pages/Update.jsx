...
const Update = () => {
     ...
     return (
          <div>
               ...
               <div>
                    <h1 className="text-3xl mb-4 font-extrabold text-blue-600 text-center"> Update Donated Food  </h1>
               </div>
               <form onSubmit={handleUpdate} action="">
                    ...
                    <div className="text-center mt-9 ">  <input className=" btn text-white btn-accent mt-2 w-full text-xl" type="submit" value="Update" /> </div>
               </form>
          </div>
          </div>
     );
